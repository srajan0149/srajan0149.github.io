...
async function add_text(_texts, user = "", addDelay = false) {
    let texts = Array();
...
function commandResp(cmd) {
    switch (cmd) {
        ...
        default:
            return add_text(["Something is wrong with your command", "maybe just try again??"], "", false);
    }
}
function delay(ms) {
